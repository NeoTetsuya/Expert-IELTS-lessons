...
window.module5Data = {
    ...
    reading5a: {
        passage: `
            ...
            <p><span class="para-tag">Para A</span> <mark class="evidence" id="ev-5a-3" data-q="5a-3"><span class="syn-pair-1" data-q="5a-3">An extraordinary cyclist, Mark Beaumont, has completed a number of amazing long-distance trips on his bike</span>. <span class="syn-pair-2" data-q="5a-3">In 2008, for example, he rode for 18,296 miles around the world. Two years later he made a 13,080-mile journey through the Americas. In 2015 he cycled 6,762 miles from Cairo to Cape Town</span></mark>.</p>
            ...
            <p><span class="para-tag">Para C</span> On all his journeys Mark has been interested by the landscapes he has seen. He says these often differ from what he expected. <mark class="evidence" id="ev-5a-1" data-q="5a-1"><span class="syn-pair-1" data-q="5a-1">When people think about Patagonia, for instance, they imagine the beautiful mountains and lakes</span>... <span class="syn-pair-2" data-q="5a-1">but when I cycled there, I realised that large parts of it are just miles and miles of grassland... What is romantic and exciting for most holidaymakers can become very boring</span> when you see nothing else for several days</mark>.</p>
            <p><span class="para-tag">Para D</span> Of all the landscapes he has seen, Mark has particularly enjoyed some of the wild parts of Texas and the Deep South of the USA. 'I remember waking before daylight. <mark class="evidence" id="ev-5a-4" data-q="5a-4"><span class="syn-pair-1" data-q="5a-4">I had to remove the ice from my tent when it was still dark</span>. <span class="syn-pair-2" data-q="5a-4">Then I set out on roads with absolutely no one else around. I was in the middle of this enormous desert</span></mark> and all I could hear was the sound of animals calling. When I look back now, it was one of my favourite times: to be totally alone in that environment.'</p>
        ...
        walkthroughs: [
            {
                ...
                excerpt: `<span class="para-tag">[Para C]</span> <mark class="evidence" id="ev-wt-5a-1" data-q="wt-5a-1">"<span class="syn-pair-1" data-q="wt-5a-1">When people think about Patagonia, for instance, they imagine the beautiful mountains</span>... but when I cycled there, I realised that large parts of it are just miles and miles of grassland... <span class="syn-pair-2" data-q="wt-5a-1">can become very boring when you see nothing else for several days</span>."</mark>`,
                question: `1. Which paragraph contains <span class="syn-pair-2" data-q="wt-5a-1">an example of a place where Mark felt bored</span>?`,
                ans: "C",
                boxOptions: [
            ...
            },
            {
                ...
                excerpt: `<span class="para-tag">[Para G]</span> <mark class="evidence" id="ev-wt-5a-2" data-q="wt-5a-2">"He says that, <span class="syn-pair-1" data-q="wt-5a-2">because the projects involve huge effort, time and costs</span>, <span class="syn-pair-2" data-q="wt-5a-2">his main emotion is relief that he has completed the trip successfully</span>."</mark>`,
                question: `2. Which paragraph contains <span class="syn-pair-1" data-q="wt-5a-2">a comment on the expense of organising a cycle trip</span>?`,
                ans: "G",
                boxOptions: [
                    { letter: "A", text: "Paragraph A" }, { letter: "B", text: "Paragraph B" }, { letter: "C", text: "Paragraph C" },
                    { letter: "D", text: "Paragraph D" }, { letter: "E", text: "Paragraph E" }, { letter: "F", text: "Paragraph F" }, { letter: "G", text: "Paragraph G" }
            ...
            },
            {
                ...
                excerpt: `<span class="para-tag">[Para A]</span> <mark class="evidence" id="ev-wt-5a-3" data-q="wt-5a-3">"<span class="syn-pair-1" data-q="wt-5a-3">Mark Beaumont, has completed a number of amazing long-distance trips on his bike</span>. <span class="syn-pair-2" data-q="wt-5a-3">In 2008, for example, he rode for 18,296 miles around the world. Two years later he made a 13,080-mile journey through the Americas. In 2015 he cycled 6,762 miles from Cairo to Cape Town</span>."</mark>`,
                question: `3. Which paragraph contains <span class="syn-pair-2" data-q="wt-5a-3">a description of the extent of Mark's travels</span>?`,
                ans: "A",
                boxOptions: [
                    { letter: "A", text: "Paragraph A" }, { letter: "B", text: "Paragraph B" }, { letter: "C", text: "Paragraph C" },
                    { letter: "D", text: "Paragraph D" }, { letter: "E", text: "Paragraph E" }, { letter: "F", text: "Paragraph F" }, { letter: "G", text: "Paragraph G" }
            ...
            },
            {
                ...
                excerpt: `<span class="para-tag">[Para D]</span> <mark class="evidence" id="ev-wt-5a-4" data-q="wt-5a-4">"<span class="syn-pair-1" data-q="wt-5a-4">I remember waking before daylight. I had to remove the ice from my tent when it was still dark</span>. <span class="syn-pair-2" data-q="wt-5a-4">Then I set out on roads with absolutely no one else around</span>."</mark>`,
                question: `4. Which paragraph contains <span class="syn-pair-1" data-q="wt-5a-4">a reference to how cold the weather was</span>?`,
                ans: "D",
                boxOptions: [
                    { letter: "A", text: "Paragraph A" }, { letter: "B", text: "Paragraph B" }, { letter: "C", text: "Paragraph C" },
                    { letter: "D", text: "Paragraph D" }, { letter: "E", text: "Paragraph E" }, { letter: "F", text: "Paragraph F" }, { letter: "G", text: "Paragraph G" }
            ...
            },
            {
                ...
                excerpt: `<span class="para-tag">[Para B]</span> <mark class="evidence" id="ev-wt-5a-5" data-q="wt-5a-5">"<span class="syn-pair-1" data-q="wt-5a-5">He explains that it was certainly not easy to keep up this speed</span>. There were, for example, <span class="syn-pair-2" data-q="wt-5a-5">long delays at border crossings and queues of traffic often stopped him... Broken roads caused problems and the weather also affected</span>..."</mark>`,
                question: `5. Which paragraph contains <span class="syn-pair-2" data-q="wt-5a-5">some reasons why making progress can be difficult</span>?`,
                ans: "B",
                boxOptions: [
                    { letter: "A", text: "Paragraph A" }, { letter: "B", text: "Paragraph B" }, { letter: "C", text: "Paragraph C" },
                    { letter: "D", text: "Paragraph D" }, { letter: "E", text: "Paragraph E" }, { letter: "F", text: "Paragraph F" }, { letter: "G", text: "Paragraph G" }
    ...
    reading5b: {
        passage: `
            ...
            <p><span class="para-tag">Para A</span> <mark class="evidence" id="ev-5b-4" data-q="5b-4"><span class="syn-pair-1" data-q="5b-4">Visual pollution means that people cannot enjoy what they see</span>. <span class="syn-pair-2" data-q="5b-4">There are two types of visual pollution in the modern world: one is when visibility is limited by haze; another is visual untidiness, when buildings and signs spoil the view</span></mark>.</p>
