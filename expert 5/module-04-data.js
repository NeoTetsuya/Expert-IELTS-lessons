...
window.module4Data = {
    ...
    reading4a: {
        passage: `
            ...
            <p><span class="para-tag">Para 1</span> Technology has become an important aspect of life for people who want to get and stay fit. They use apps on their smartphone or other devices, for example, to count the number of steps they take every day, to measure their heart rate, to record their sleep patterns and to work out how many calories they <span class="vocab-word" data-word="consume" data-ipa="/kənˈsjuːm/" data-pos="verb" data-def="To eat, drink, or use up a resource." data-colloc="calories">consume</span>.</p>
            <p><span class="para-tag">Para 2</span> <mark class="evidence" id="ev-4a-1" data-q="4a-1"><span class="syn-pair-1" data-q="4a-1">Sports scientists recognise that deciding to use a fitness tracker or app is good</span> because it means <span class="syn-pair-2" data-q="4a-1">a person is curious about health and keen to improve their habits</span></mark>. If the attractive design of a device or app encourages an interest in keeping fit, its <span class="vocab-word" data-word="impact" data-ipa="/ˈɪm.pækt/" data-pos="noun" data-def="A powerful effect or influence on a situation." data-colloc="positive impact">impact</span> is clearly positive. After all, many people have reported that fitness devices have <span class="vocab-word" data-word="motivated" data-ipa="/ˈməʊ.tɪ.veɪ.tɪd/" data-pos="adj." data-def="Very enthusiastic and determined to do something." data-colloc="motivated them">motivated</span> them to get off the sofa and go for a walk after dinner. Unfortunately, however, many of those after-dinner walkers have added that <mark class="evidence" id="ev-4a-2" data-q="4a-2"><span class="syn-pair-1" data-q="4a-2">when their devices broke and they no longer knew how many steps they had taken</span>, <span class="syn-pair-2" data-q="4a-2">there seemed little point in heading out for that walk</span></mark>. <span class="vocab-word" data-word="Consequently" data-ipa="/ˈkɒn.sɪ.kwənt.li/" data-pos="adv." data-def="As a result of an action or circumstance." data-colloc="Consequently agree">Consequently</span>, sports scientists agree that people need to be aware of the fact that apps alone are not enough.</p>
    ...
    reading4b: {
        passage: `
            ...
            <p><span class="para-tag">Para 2</span> <mark class="evidence" id="ev-4b-2" data-q="4b-2"><span class="syn-pair-1" data-q="4b-2">Most people are amazed to discover that our <span class="vocab-word" data-word="dependence" data-ipa="/dɪˈpen.dəns/" data-pos="noun" data-def="The state of relying on or needing something." data-colloc="dependence on nature">dependence</span> on nature for health has not reduced</span>. Over the past quarter century, <span class="syn-pair-2" data-q="4b-2">more than half of all the products that drug companies have developed actually use, or copy, <span class="vocab-word" data-word="substances" data-ipa="/ˈsʌb.stəns.ɪz/" data-pos="noun" data-def="Particular kinds of matter or chemical compounds." data-colloc="natural substances">substances</span> from the natural world</span></mark>. Moreover, the World Health Organization estimates that in many developing countries, 80 percent of the population relies on traditional medicines from natural sources.</p>
            ...
            <p><span class="para-tag">Para 4</span> Unfortunately, the <span class="vocab-word" data-word="ecosystems" data-ipa="/ˈiː.kəʊˌsɪs.təmz/" data-pos="noun" data-def="Biological communities of interacting organisms and their physical environment." data-colloc="different ecosystems">ecosystems</span> that provide some of the world's most important drugs, such as rainforests and coral reefs, are also the ecosystems that are most at risk today. There are concerns that warming temperatures mean that few coral reefs will remain by the end of the century. Meanwhile, <mark class="evidence" id="ev-4b-4" data-q="4b-4"><span class="syn-pair-1" data-q="4b-4">agriculture and various major development projects are making the world's rainforests vanish</span> at an alarming rate... <span class="syn-pair-2" data-q="4b-4">The <span class="vocab-word" data-word="inevitable" data-ipa="/ɪnˈev.ɪ.tə.bəl/" data-pos="adj." data-def="Certain to happen and unable to be avoided." data-colloc="inevitable result">inevitable</span> result is that many species with important medicinal powers will become extinct</span></mark>.</p>
            <p><span class="para-tag">Para 5</span> Another problem is that most of nature's medicines do not come from big and beautiful mammals, such as tigers and elephants. <mark class="evidence" id="ev-4b-5" data-q="4b-5">Instead, <span class="syn-pair-1" data-q="4b-5">they come from the least popular of the world's ecosystems: plants, fungi and <span class="vocab-word" data-word="invertebrates" data-ipa="/ɪnˈvɜː.tɪ.brəts/" data-pos="noun" data-def="Animals without a backbone, such as insects and worms." data-colloc="marine invertebrates">invertebrates</span></span>. Some particularly valuable species are <span class="syn-pair-2" data-q="4b-5">often either <span class="vocab-word" data-word="poisonous" data-ipa="/ˈpɔɪ.zən.əs/" data-pos="adj." data-def="Causing illness or death if touched or consumed; toxic." data-colloc="poisonous species">poisonous</span> or so small that we cannot see them without a microscope</span>. This makes campaigning for their <span class="vocab-word" data-word="preservation" data-ipa="/ˌprez.əˈveɪ.ʃən/" data-pos="noun" data-def="The act of keeping something safe from loss or damage." data-colloc="campaigning for preservation">preservation</span> much more difficult</mark>.</p>
