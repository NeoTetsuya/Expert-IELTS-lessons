 ...
 *   3. Modular Theme CSS files from /themes_src/ into themes.css
 *
 * Usage:
 *   node build-bundle.js            -- build JS + CSS + themes (default)
 *   node build-bundle.js --js-only  -- only rebuild deck-bundle.js
 *   node build-bundle.js --css-only -- only rebuild presentation-base.css + themes.css
 */
const fs = require('fs');
...
// ==========================================
if (!jsOnly && fs.existsSync(cssSrcDir)) {
...
if (!jsOnly && fs.existsSync(themesSrcDir)) {
